...
//		list.add(new Account(name, id, pass, ssn, tel,balance));
		...
		case "입력":
            ...
            String name = jt1.getText(); // JTextField에서 이름 가져오기
             
            String id = jt2.getText();
            String pass = jt3.getText();
            String ssn = jt4.getText();
            String tel = jt5.getText();
            String balanceEt = jt6.getText();
            int balance = Integer.parseInt(jt6.getText());
            Account account = new Account(name, id, pass, ssn, tel,balance);
            list.add(account);
            break;
