...
<main class="form-signin w-100 m-auto">
  <form>
    ...
    <div class="form-floating">
      <input type="email" class="form-control" id="floatingPassword" placeholder="이메일주소(ex@exam.com)">
    ...
    <button class="btn btn-secondary w-100 py-2" type="submit">로그인(Login)</button>
