...
<body>
	...
	<script type="text/javascript">
		...
		function addRow(conent) {
		    ...
		    //table.innerHTML += content; // 기존 내용 뒤에 추가
		...
		//window.onload = function() {
			//익명함수
			//let data = "<tr><td>111</td></tr><tr><td>222</td></tr>";
			//let data="<tr><td><a href='http://www.naver.com'>네이버</a></td></tr>"+"<tr><tr><td>333</td>"+"</tr><tr><tr><td><a href='http://www.naver.com'>네이버3</a></td></tr><tr>";
		//	let data=`<tr>
		//	<td><a href="http://www.naver.com">네이버</a></td>
		//	<td>333</td><td>
		//	<a href="http://www.naver.com">네이버3</a></td>
		//	</tr>`;
